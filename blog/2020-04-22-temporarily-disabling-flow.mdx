...
description: There are some cases in which you'd like to suppress a flow in Power
...
tags:
  ...
  - flow
---
There are some cases in which you'd like to suppress a flow in Power Automate for certain period of time. Be careful - turning it off doesn't always work as expected!
