...
date: 2023-03-23T10:37:00.0000000Z
...
![Canvas app with two images](../../img/get-media-powerapps/20230317-083954-oYWJ6r9njN-0.png)

When I go to the media library in the app, I can see that there is no option to export the media:

![Context menu without the export option](../../img/get-media-powerapps/20230317-084312-D8Vorq3Maq-0.png)
...
![Play button in the PowerApps app editor](../../img/get-media-powerapps/20230317-084843-cYrEyOdij2-0.png)

From here we can right-click the image and choose **Inspect**:

![Choosing Inspect button](../../img/get-media-powerapps/20230317-085654-wTg5CGJxaH-0.png)

![Choosing Inspect button](../../img/get-media-powerapps/20230317-085654-wTg5CGJxaH-0.png)

The **Inspect** option will open dev tools. It'll automatically select one of the elements close to the image:

![Dev tools with div element selected](../../img/get-media-powerapps/20230320-082641-BvGWtVREWt-0.png)
...
![Img element in developer tools](../../img/get-media-powerapps/20230320-083334-Wsvs4M8Krv-0.png)

Now when we hover over the hyperlink we'll have the option to open it in a new tab. Let's click the hyperlink:

![Image link in developer tools](../../img/get-media-powerapps/20230320-083500-MIePOsetpa-0.png)

From here we can save it:

![Context menu with the option to save the image selected ](../../img/get-media-powerapps/20230320-083618-6Or4UuFIHa-0.png)
...
![Download window with webpage, complete type selected](../../img/get-media-powerapps/20230320-085743-5E9S7Zdubt-0.png)

As a result, we'll have the HTML file and the folder containing all the files:

![Webpage and the folder with associated files in Windows Explorer](../../img/get-media-powerapps/20230321-140445-Mlh7zfF6Qc-0.png)

The folder contains many files and our two images:

![Folder with files, including uploaded images](../../img/get-media-powerapps/20230321-140823-7qDMsLvkzo-0.png)
...
![Exporting the app from PowerApps portal](../../img/get-media-powerapps/20230321-141341-tUdloSdcn1-0.png)

From here we need to put any name (1) and click the **Export** button (2):

![Exporting wizard with random name entered](../../img/get-media-powerapps/20230321-141524-xyvY1jXFvX-0.png)

We'll get the ZIP file. Let's extract it:

![Context menu with Extract All option](../../img/get-media-powerapps/Untitled-0.png)
...
![File with .msapp extension](../../img/get-media-powerapps/20230321-142144-hnj1ILFGQx-0.png)

Rename the file to *.zip* and confirm:

![Changing the extension from .msapp to .zip](../../img/get-media-powerapps/20230321-142925-pn3X5aYMaF-0.png)

The *.zip* file will have all the images under *Assets > Images*:

![Images located under Assets folder in Images subfolder](../../img/get-media-powerapps/20230321-143134-RFfBKY27XP-0.png)
...
![Properties comparison of two files](../../img/get-media-powerapps/20230323-111918-YgOsEBtP1b-0.png)
