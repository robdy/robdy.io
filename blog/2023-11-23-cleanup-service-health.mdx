...
First and foremost, let's make the email never arrive. Using our admin account let's go to *Service Health* (1) > *Customize* ([direct link](https://admin.microsoft.com/Adminportal/Home#/servicehealth/:/shdpreferences)). From here, switch to the *Email* tab (3):
...
![Renaming actions](../../img/cleanup-service-health/Untitled-0.png)
...
The first action in the flow is to get emails (*Office 365 Outlook* > *Get emails (V3)*). We will use the following properties:
