...
- [Checklist only](#checklist-only)
- [Table of Contents](#table-of-contents)
- [Frequent issues](#frequent-issues)
- [Start with the invitation](#start-with-the-invitation)
  - [Response options](#response-options)
  - [Skype meeting options](#skype-meeting-options)
    - [Presenter or attendee?](#presenter-or-attendee)
    - [Available Skype meeting options](#available-skype-meeting-options)
