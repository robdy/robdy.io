...
## I don't see any policies to choose

If we don't see any policies to choose from in the **Assign policy** section in Outlook, we've met a glitch in Outlook.

The easiest way to fix that glitch is to restart Outlook. 
