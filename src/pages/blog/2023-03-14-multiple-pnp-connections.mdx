...
![Return from the cmdlet showing only the second site](../../img/multiple-pnp-connections/20230314-142702-uLUpotIGXf-0.png)
...
![Return from Get-PnPConnection cmdlet showing only the second site](../../img/multiple-pnp-connections/20230314-143024-bQDX1a5xMu-0.png)

There is only one connection returned. We cannot find the first connection at all.

![](../../img/multiple-pnp-connections/20230314-143024-bQDX1a5xMu-1.png)
...
![Return from Get-PnPConnection showing an error](../../img/multiple-pnp-connections/20230314-143403-YjCRUziK3L-0.png)

![](../../img/multiple-pnp-connections/20230314-143403-YjCRUziK3L-1.png)
...
![Return from Get-PnPConnection showing both sites](../../img/multiple-pnp-connections/20230314-145614-H0UmG5MSEI-0.png)
...
![](../../img/multiple-pnp-connections/20230314-145614-H0UmG5MSEI-1.png)
