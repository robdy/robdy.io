...
```powershell
<# Result from previos step #> | Select-String -Pattern ($cmdletsToBeChecked -join "|")
```
...
In this article we've build a script to do proper discovery. We learned about useful cmdlets, splitting array and using regular expression.
