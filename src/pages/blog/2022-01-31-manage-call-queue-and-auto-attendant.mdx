...
$callableEntityPerson = New-CsAutoAttendantCallableEntity -Identity $operatorObjectId -Type User
...
$callableEntityQueue = New-CsAutoAttendantCallableEntity -Identity $operatorQueueAccountId -Type ApplicationEndpoint
...
$callableEntityAttendant = New-CsAutoAttendantCallableEntity -Identity $operatorAttendantAccountId -Type ApplicationEndpoint
