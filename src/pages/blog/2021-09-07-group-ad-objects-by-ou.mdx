...
In our example, `CN=` is matched based on the character matching. Next, the `*` quantifier matches as many other characters as it can, provided they are followed by `,`. 
