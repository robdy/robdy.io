...
![Untitled](../../img/pull-notion-site/Untitled%201.png)
...
![Creating a new database in the wizard](../../img/pull-notion-site/Untitled%202.png)

From here we’ll see the database with 3 empty records:

 

![The database with 3 empty records](../../img/pull-notion-site/Untitled%203.png)

Let’s add some names to it:

 

![The database with names](../../img/pull-notion-site/Untitled%204.png)
...
![Saving the edits](../../img/pull-notion-site/Untitled%205.png)
...
![Integration capabilities](../../img/pull-notion-site/Untitled%206.png)
...
![Database query response](../../img/pull-notion-site/Untitled%207.png)

It’s quite clear that we’re interested in the `results` property. Let’s inspect it:

![Objects in the results property](../../img/pull-notion-site/Untitled%208.png)
...
![Page block’s children objects](../../img/pull-notion-site/Untitled%209.png)
