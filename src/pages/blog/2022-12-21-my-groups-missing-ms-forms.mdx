...
![Starting page without the ‘My groups' section](../../img/my-groups-missing-ms-forms/Untitled.png)
...
1. Go to[ forms.office.com](https://forms.office.com) once again. You'll see another welcome page:

![Welcome page after creating the first form](../../img/my-groups-missing-ms-forms/20221221-160636-vbZZ2EZdvf.png)

1. Scroll down and you'll find **My Groups** section:
