...
> We confirm that the webinar is included on the Business Standard and Business Premium licenses however **it does not have the fancy button** that you will see on the enterprise license.
>
...
> **NOTE**: It's unclear whether in non-enterprise plans you still have the ability to escalate the webinar to a Live Event if it gets more than 1000 attendees.
