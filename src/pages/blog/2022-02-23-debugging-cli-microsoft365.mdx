...
![Replacing argument with file path](../../img/20220330-100823-skg4zouvkm.png)

<Note>

There's a bug in the launch file now. It causes all the tests to run regardless of the arguments. To resolve it, we need to add one additional parameter to the *args* array: `--no-config`.

In our example, the array will look as below:
...
The issue is reported as [\#3180 in the CLI-Microsoft365 repo](https://github.com/pnp/cli-microsoft365/issues/3180).
