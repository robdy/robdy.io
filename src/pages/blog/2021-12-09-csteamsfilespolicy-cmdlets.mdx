...
/Teams-PhoneNumbersManager](https://github.com/timoleo23/Teams-PhoneNumbersManager), which seems to be an interesting solution to manage phone numbers in Teams.
