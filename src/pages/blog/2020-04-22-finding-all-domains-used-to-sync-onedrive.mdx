...
- [Prerequisites](#prerequisites)
	- [Auditing turned on](#auditing-turned-on)
	- [Exchange Online PowerShell module installed](#exchange-online-powershell-module-installed)
	- [Proper role](#proper-role)
- [Getting data from GUI](#getting-data-from-gui)
- [Getting data programatically](#getting-data-programatically)
