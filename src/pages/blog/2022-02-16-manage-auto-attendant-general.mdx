...
What do *general settings* mean? You can find them under the section named *General* in auto attendant configuration wizard. In the article I will be going through these settings:
