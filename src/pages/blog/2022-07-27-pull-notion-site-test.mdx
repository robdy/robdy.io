...
date: 2022-07-27T19:24:00.0000000Z
description: The article demonstrates getting the site content from Notion using PowerShell. It uses free Notion API to pull all the blocks.
featuredpost: false
tags:
  - powershell
  - notion
...
![Creating new page in Notion](../../img/pull-notion-site-test/Untitled.png)

Let's name it *Test DB* and create a database table:

![](../../img/pull-notion-site-test/Untitled-0.png)
...
![Creating a new database in the wizard](../../img/pull-notion-site-test/Untitled-1.png)

From here we'll see the database with 3 empty records:

![The database with 3 empty records](../../img/pull-notion-site-test/Untitled-2.png)

Let's add some names to it:

![The database with names](../../img/pull-notion-site-test/Untitled-3.png)

Now let's add some content. Click *Open* (1) next to the page name. Then hit *Enter* or click below the comment section (2):

![Adding the content to the page](../../img/pull-notion-site-test/20220721-153620-gQ6L73nosb.png)

Add some content there and click outside the page view to save:

![Saving the edits](../../img/pull-notion-site-test/Untitled-4.png)
...
![Integration capabilities](../../img/pull-notion-site-test/Untitled-5.png)
...
![Database query response](../../img/pull-notion-site-test/Untitled-6.png)

It's quite clear that we're interested in the `results` property. Let's inspect it:

![Objects in the results property](../../img/pull-notion-site-test/Untitled-7.png)
...
![Page block's children objects](../../img/pull-notion-site-test/Untitled-8.png)
